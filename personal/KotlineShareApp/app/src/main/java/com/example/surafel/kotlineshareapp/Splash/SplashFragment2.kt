...
import kotlinx.android.synthetic.main.fragment_splash_fragment2.view.*
...
class SplashFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val imageView = view.iv_fragment2_header
        Glide.with(view.context).load(R.drawable.build).into(imageView)
        return view
    }
